...
Make sure to install database dependencies [psycopg2, python-dotenv, sqlalchemy]
-Check stroke_heart_prediciton/requirements.txt (Remark For Mac, Linux Users psycopg2-binary) 👈
Create a (.env) file in the main Root => stroke_heart_prediciton/.env
...
Open terminal and go to Cd stroke_heart_prediciton/postgres
Run Python createdb.py to create the tables & relationships in your database
Execute Program Locally:
Cd stroke_heart_prediciton/stroke_api; uvicorn main:app --host 0.0.0.0 --port 8005;

streamlit run web_interface.py --server.port 8010;

System Architecture: 🧱
<img width="1129" height="722" alt="image" src="https://github.com/user-attachments/assets/a444463f-bce3-4514-a01b-acd384cb57dd" />
